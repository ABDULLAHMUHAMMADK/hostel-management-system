    ...
    <div className="w-full h-full max-h-[calc(100vh-80px)] p-6 overflow-y-auto font-sans bg-slate-50 flex flex-col items-center">
      <div className="max-w-3xl w-full space-y-6 my-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="group relative bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4 overflow-hidden pl-6">
            {/* Animated left indicator line */}
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-1/5 bg-indigo-600 rounded-r-md transition-all duration-300 ease-in-out group-hover:h-full" />
          ...
          <div className="group relative bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4 overflow-hidden pl-6">
            {/* Animated left indicator line */}
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-1/5 bg-teal-600 rounded-r-md transition-all duration-300 ease-in-out group-hover:h-full" />
