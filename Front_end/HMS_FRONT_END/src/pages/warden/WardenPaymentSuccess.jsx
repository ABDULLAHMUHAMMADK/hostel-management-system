...
import { CheckCircle, ArrowRight, ShieldCheck, Building2 } from "lucide-react";

export default function WardenPaymentSuccess() {
    ...
    <div className="h-[calc(100vh-80px)] flex items-center justify-center bg-slate-50 p-4 select-none">
      ...
      >
        ...
        <p className="text-slate-500 text-sm font-medium mt-4 leading-relaxed max-w-xs">
          Your hostel rent invoice has been cleared successfully. Your account balance and hostel financials are now updated across the system.
        </p>
